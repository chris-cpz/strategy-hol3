...
[![GitHub Stars](https://img.shields.io/github/stars/chris-cpz/strategy-hol3?style=for-the-badge&logo=github)](https://github.com/chris-cpz/strategy-hol3)
...
```bash
# Clone repository
git clone https://github.com/chris-cpz/strategy-hol3.git
cd strategy-hol3
...
```python
from strategy import HOL3Strategy

# Initialize strategy
strategy = HOL3Strategy()
...
- **Documentation**: [Wiki](https://github.com/chris-cpz/strategy-hol3/wiki)
- **Issues**: [GitHub Issues](https://github.com/chris-cpz/strategy-hol3/issues)
- **Discussions**: [GitHub Discussions](https://github.com/chris-cpz/strategy-hol3/discussions)
